...
public class MazeUtil {
    ...
    public static List<State> getStates() {
        ...
        IRI isIn = rdf.createIRI(MazeOntology.isIn);
        Resource room1 = rdf.createIRI(MazeOntology.room1);
        Resource room2 = rdf.createIRI(MazeOntology.room2);
        Resource room3 = rdf.createIRI(MazeOntology.room3);
        Resource room4 = rdf.createIRI(MazeOntology.room4);
        Resource room5 = rdf.createIRI(MazeOntology.room5);
        Resource room6 = rdf.createIRI(MazeOntology.room6);
        Resource room7 = rdf.createIRI(MazeOntology.room7);
        Resource room8 = rdf.createIRI(MazeOntology.room8);
        Resource room9 = rdf.createIRI(MazeOntology.room9);
